        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
            <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground text-sm mt-2">
                    {step === 1 ? t('enterDetails', 'auth') : "Check your email for the code."}
                </p>
            </div>
                ...
                <>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            ...
                            <input value={firstName} onChange={e => setFirstName(e.target.value)} className="shadcn-input" placeholder="Jane" />
                        </div>
                        <div className="space-y-1">
                            <label className="text-sm font-medium">{t('lastName', 'auth')}</label>
                            <input value={lastName} onChange={e => setLastName(e.target.value)} className="shadcn-input" placeholder="Doe" />
                        </div>
                    </div>
                    <div className="space-y-1">
            ...
            <div className="mt-6 text-center pt-4 border-t">
                <p className="text-muted-foreground text-sm">
                    Already have an account? <button onClick={onLoginClick} className="text-primary font-semibold hover:underline">{t('signIn', 'auth')}</button>
                </p>
            </div>
        </div>
    );
