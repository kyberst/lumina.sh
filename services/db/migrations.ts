...
export const runMigrations = (db: any, isUpdate: boolean) => {
    ...
    db.run(`CREATE TABLE IF NOT EXISTS projects (id TEXT PRIMARY KEY, prompt TEXT, timestamp INTEGER, description TEXT, files TEXT, tags TEXT, mood INTEGER, sentimentScore REAL, project TEXT, contextSource TEXT, envVars TEXT, dependencies TEXT);`);
