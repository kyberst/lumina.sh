      ...
      {toasts.map((t) => (
        ...
        >
            <div className="flex gap-3 items-center">
                ...
                {t.type === 'loading' && <div className="text-indigo-500 animate-spin"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12a9 9 0 1 1-6.219-8.56" /></svg></div>}
                
                <div className="grid gap-1">
                    <p className="text-sm font-medium leading-none text-slate-950">
                        {t.type === 'success' ? 'Success' : t.type === 'error' ? 'Error' : t.type === 'loading' ? 'Processing' : 'Notification'}
                    </p>
